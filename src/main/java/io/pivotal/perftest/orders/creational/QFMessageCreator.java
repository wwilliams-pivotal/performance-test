...
public class QFMessageCreator implements Creator<QFMessage>
{

	private String nodeId;
	
	public QFMessageCreator(String nodeId) {
		this.nodeId = nodeId;
	}

	public QFMessage create()
	{
		QFMessage qfMessage = new QFMessage();
		qfMessage.setDestSession("");	
		qfMessage.setItemFormat("fix");
		qfMessage.setItemType("infix");
		qfMessage.setMsgId(nodeId + "pvt.17535."+qfMessageCounter+1);
